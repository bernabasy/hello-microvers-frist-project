...
```bash
git clone https://github.com/bernabasy/hello-microvers-frist-project.git
To get a local copy up and running follow these simple steps:
 -On your terminal/IDE use the command "git clone [https://github.com/mckent05/Hello_Project.git"](https://github.com/bernabasy/hello-microvers-frist-project.git) "
